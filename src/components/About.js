...
const About = () => (
  <Box id="about" py={8} minHeight="100vh" display="flex" flexDirection="column" justifyContent="center" width="100%">
    <Container id='about-section' maxW="container.md" textAlign="center" alignItems="center">
